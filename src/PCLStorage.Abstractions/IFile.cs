...
namespace PCLStorage
{
    ...
    public interface IFile
    {
        ...
        /// Gets the file path.
        /// </summary>
        /// <value>The "full path" of the file, which should uniquely identify it within a given <see cref="IFileSystem"/>.</value>
        string Path { get; }
        ...
        /// <param name="collisionOption">Specifies how to deal with collisions with existing files.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>
