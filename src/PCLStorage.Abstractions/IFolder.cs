...
namespace PCLStorage
{
    ...
    {
        /// <summary>
        /// Creates a new file with a unique name of the form "<c>name (2).txt</c>".
        /// </summary>
    ...
    public interface IFolder
    {
        ...
        /// </summary>
        /// <value>The "full path" of the folder, which should uniquely identify it within a given <see cref="IFileSystem"/>.</value>
        string Path { get; }
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The requested file, or <c>null</c> if it does not exist.</returns>
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The requested folder, or <c>null</c> if it does not exist.</returns>
